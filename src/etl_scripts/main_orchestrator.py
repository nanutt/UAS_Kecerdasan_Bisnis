...
CORE_DW_DB_FILE = DATA_ROOT / "05_core_dw" / "core_dw_mart.db" # Ganti dengan path DB PRODUKSI Anda
...
def main_etl_workflow():
    ...
    menggunakan DRP dan Callback Logging.
    """
    process_name = "DAILY_ETL_WORKFLOW"
    ...
    try:
        ...
        # >>> ERROR CALLBACK <<<
        # =================================================================
        error_message = f"Proses ETL GAGAL Total. Lokasi Kegagalan: {e.__traceback__.tb_frame.f_code.co_name}, Error: {str(e)}"
        ...
        print(f"\n=======================================================")
        print(f"❌ PROSES ETL GAGAL TOTAL. Detail dicatat di Audit Log.")
        print(f"=======================================================")
